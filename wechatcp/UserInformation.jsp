			...
			jQuery.ajax({
				...
				success: function (data) {
					...
					if(data.success==true){
						...
						//window.location.replace("../InfoCommunication/InfoCommunication.jsp?token=" + token );
...
//    out.println(cpUserInformation.getUserInformation(request.getParameter("code")));
%>
<%--<img src="http://omxua3n7b.bkt.clouddn.com/FjBCDRqa-yvLYDNYElaa9ENaWc4X">--%>
</body>
</html>
